...
public class Main {
    ...
    public static String fairRations(List<Integer> B) {
        ...
        if (B.size() > 2) {
            ...
            if (isOdd(B.get(size - 1))) {
                result = "NO";
            } else {
                result = String.valueOf(counter);
            }
        } else {
            if (isOdd(B.get(0)) && isOdd(B.get(1))) {
                result = "2";
            } else if (!isOdd(B.get(0)) && !isOdd(B.get(1))) {
                result = "0";
            } else {
                result = "NO";
            }
